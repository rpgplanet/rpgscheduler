...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('convention_proposal', (
        ...
        db.send_create_signal('convention', ['Proposal'])

        # Adding model 'ProposalVote'
        db.create_table('convention_proposalvote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('proposal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['convention.Proposal'])),
        ))
        db.send_create_signal('convention', ['ProposalVote'])

        # Adding unique constraint on 'ProposalVote', fields ['user', 'proposal']
        db.create_unique('convention_proposalvote', ['user_id', 'proposal_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ProposalVote', fields ['user', 'proposal']
        db.delete_unique('convention_proposalvote', ['user_id', 'proposal_id'])

        # Deleting model 'Proposal'
        db.delete_table('convention_proposal')

        # Deleting model 'ProposalVote'
        db.delete_table('convention_proposalvote')
