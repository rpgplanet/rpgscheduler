...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Proposal.original_start'
        db.delete_column('convention_proposal', 'original_start')

        # Deleting field 'Proposal.original_end'
        db.delete_column('convention_proposal', 'original_end')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Proposal.original_start'
        raise RuntimeError("Cannot reverse this migration. 'Proposal.original_start' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Proposal.original_end'
        raise RuntimeError("Cannot reverse this migration. 'Proposal.original_end' and its values cannot be restored.")
    ...
    models = {
        ...
        'convention.proposalvote': {
            'Meta': {'unique_together': "(('user', 'proposal'),)", 'object_name': 'ProposalVote'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proposal': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['convention.Proposal']"}),
